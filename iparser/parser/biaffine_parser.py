...
from iparser.parser.common import biLSTM, leaky_relu, bilinear, orthonormal_initializer, arc_argmax, rel_argmax, \
...
class BiaffineParser(object):
    def __init__(self, vocab,
        ...
        if char_dims > 0:
            ...
            self.char_lstm = None
        self.pret_word_embs = pc.lookup_parameters_from_numpy(vocab.get_pret_embs(word_dims)) if vocab.has_pret_embs() else None
